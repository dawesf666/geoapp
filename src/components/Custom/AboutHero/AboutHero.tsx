...
export function AboutHero() {
  return (
    <div className="relative mx-auto my-10 flex flex-col items-center justify-center space-y-10">
      {/* <Navbar /> */}
          ...
          <div className="flex-1 items-center text-white">
            <div className="block p-10 ">
              <p className="mt-10 text-xl font-bold">
                ...
                Catania e il Presidio Partecipativo del Fiume Simeto. Terrapiena mira a promuovere
                la partecipazione democratica informata e consapevole delle comunità locali ai
                processi di trasformazione territoriale innescati dalla costruzione di
                infrastrutture industriali per la produzione di energia rinnovabile. A questo fine,
          ...
          <div className="flex-1 flex items-center text-white">
            <div className="block p-10">
              <p className="mb-10 text-xl font-bold">
                ...
                Nature-Positive Societies). BioTraCes mira a ripristinare la biodiversità di nove
                ...
                intervento. BioTraCes è imperniato sui principi della pluralizzazione delle
                conoscenze, capacitazione delle comunità locali, politicizzazione delle loro azioni
                e radicamento delle pratiche trasformative..
              </p>
            </div>
          </div>
        </div>
